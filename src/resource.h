...
#define mainFormStartBitmap        2
#define mainFormSelectBitmap       3

// dialogs
#define infoForm                   4
#define infoFormAppIcon            5
#define infoFormHelioBitmap        6
#define infoFormWebLinkString      7
#define infoFormInfoString         8
#define infoFormCopyrightString_1  9
#define infoFormCopyrightString_2  10
#define infoFormCopyrightString_3  11
#define infoFormVersionString_1    12
#define infoFormVersionString_2    13
#define infoFormDisclaimerString_1 14
#define infoFormDisclaimerString_2 15
#define infoFormOkButton           16
