...
extern void GameInitialize(PreferencesType *);
extern void GameReset();
extern void GameEmulation(PreferencesType *, UWORD);
extern void GameTerminate(PreferencesType *);
extern void EmulateFrame();
